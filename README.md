...
The blog site should have at least the following pages:
-	Home page
-	About page
-	List of blog posts
...
There were also some requirements:
- The home page should feature a 'Latest Posts' section, designed as a carousel (slider) for the desktop version.
...
I had to use JavaScript for validation, and to show error messages if the values in the textboxes do not meet the requirements.
